...
- Confirmar `git diff --check` sin errores de espacios en blanco.
...
- Las métricas narrativas deben estar alineadas entre README, informe, panel de control y `data/processed/narrative_metrics_official.csv`.

## Criterios de publicación
- Los datos son sintéticos y deben etiquetarse como tal en cualquier entrega.
- Los umbrales de mantenimiento requieren calibración antes de uso operacional.
- El RUL debe interpretarse como ventana relativa de intervención, no como fecha exacta de fallo.
- La planificación es heurística y no sustituye una optimización formal de capacidad.
